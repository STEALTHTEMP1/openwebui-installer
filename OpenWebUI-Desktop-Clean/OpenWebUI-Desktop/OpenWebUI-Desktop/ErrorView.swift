...
struct ErrorView: View {
    ...
    /// Creates a view displaying a troubleshooting tip with an icon, title, and description.
    /// - Parameters:
    ...
    /// - Returns: A view representing the formatted troubleshooting tip.
...
struct DiagnosticReportView: View {
    ...
    /// Asynchronously generates a diagnostic report containing error details, system information, runtime environment paths, troubleshooting steps, and support resources, and updates the report content state when complete.
